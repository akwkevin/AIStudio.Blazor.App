...
namespace AIStudio.Blazor.UI.Services
{
    ...
    public class ChartService : IChartService
    {
        ...
        private async Task<ChartData> GetChartDataAsync()
        {
            ...
            //return await _httpClient.GetFromJsonAsync<ChartData>("_content/AIStudio.Blazor.UI/data/fake_chart_data.json");
            var assembly = Assembly.GetExecutingAssembly();
            var stream = assembly.GetManifestResourceStream("AIStudio.Blazor.UI.wwwroot.data.fake_chart_data.json");
