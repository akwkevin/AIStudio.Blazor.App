...
namespace AIStudio.BlazorDiagram.Pages.DatabaseDesigner
{
    public partial class Index : IDisposable
    {
        ...
        private async Task ShowJson()
        {
            ...
            {
                Nodes = Diagram.Nodes.Select(p => new DiagramNode(p)),
                Links = Diagram.Links.Select(p => p),
                Groups = Diagram.Groups.Select(p => p),
