...
namespace AIStudio.Business.OA_Manage.Step
{
    ...
    public class OAExtension
    {
        ...
        {
            IBase_DepartmentBusiness _base_DepartmentBusiness = ServiceLocator.Instance.GetRequiredService<IBase_DepartmentBusiness>();
            IBase_UserBusiness _base_UserBusiness = ServiceLocator.Instance.GetRequiredService<IBase_UserBusiness>();
            IBase_RoleBusiness _base_RoleBusiness = ServiceLocator.Instance.GetRequiredService<IBase_RoleBusiness>();
            IBase_UserRoleBusiness _base_UserRoleBusiness = ServiceLocator.Instance.GetRequiredService<IBase_UserRoleBusiness>();
