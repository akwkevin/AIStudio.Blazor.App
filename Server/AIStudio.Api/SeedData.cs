        ...
        public static void EnsureSeedData(IServiceProvider provider)
        {
            ...
            if (dictionaryCount == 0)
            {
                List<Base_Dictionary> dictionaries = new List<Base_Dictionary>()
                {
                    ...
                    new Base_Dictionary(){ Id="Id13_3",Deleted = false, ParentId="Id13", Type = DictionaryType.数据集, Category = "选项", Text = "特级", Value="2", Code ="",  Sort=3, CreateTime=DateTime.Now, CreatorId = "System", CreatorName = "System",},
                    ...
                    new Base_Dictionary(){ Id="Id1000_1_1",Deleted = false, ParentId="Id1000_1",  Type = DictionaryType.数据集, Category = "流程", Text = "病假/天", Value="病假/天", Code = "", Sort=1, CreateTime=DateTime.Now, CreatorId = "System", CreatorName = "System", },
                    new Base_Dictionary(){ Id="Id1000_1_2",Deleted = false, ParentId="Id1000_1",  Type = DictionaryType.数据集, Category = "流程", Text = "事假/天", Value="事假/天", Code = "", Sort=2, CreateTime=DateTime.Now, CreatorId = "System", CreatorName = "System", },
                    new Base_Dictionary(){ Id="Id1000_1_3",Deleted = false, ParentId="Id1000_1",  Type = DictionaryType.数据集, Category = "流程", Text = "调休/天", Value="调休/天", Code = "", Sort=3, CreateTime=DateTime.Now, CreatorId = "System", CreatorName = "System", },
                    new Base_Dictionary(){ Id="Id1000_1_4",Deleted = false, ParentId="Id1000_1",  Type = DictionaryType.数据集, Category = "流程", Text = "年假/天", Value="年假/天", Code = "", Sort=4, CreateTime=DateTime.Now, CreatorId = "System", CreatorName = "System", },

                    new Base_Dictionary(){ Id="Id1000_2_1",Deleted = false, ParentId="Id1000_2",  Type = DictionaryType.数据集, Category = "流程", Text = "差旅费用/元", Value="差旅费用/元", Code = "", Sort=1, CreateTime=DateTime.Now, CreatorId = "System", CreatorName = "System", },
                    new Base_Dictionary(){ Id="Id1000_2_2",Deleted = false, ParentId="Id1000_2",  Type = DictionaryType.数据集, Category = "流程", Text = "采购费用/元", Value="采购费用/元", Code = "", Sort=2, CreateTime=DateTime.Now, CreatorId = "System", CreatorName = "System", },
                    new Base_Dictionary(){ Id="Id1000_2_3",Deleted = false, ParentId="Id1000_2",  Type = DictionaryType.数据集, Category = "流程", Text = "活动费用/元", Value="活动费用/元", Code = "", Sort=3, CreateTime=DateTime.Now, CreatorId = "System", CreatorName = "System", },
                    new Base_Dictionary(){ Id="Id1000_2_4",Deleted = false, ParentId="Id1000_2",  Type = DictionaryType.数据集, Category = "流程", Text = "日常费用/元", Value="日常费用/元", Code = "", Sort=4, CreateTime=DateTime.Now, CreatorId = "System", CreatorName = "System", },
                };
